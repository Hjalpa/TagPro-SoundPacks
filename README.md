...
3. Upload the .tpsp file somewhere. *Alternatively: copy your .tpsp into [pastebin](https://pastebin.com), and click (after saving) on `raw` to get its URL.* Now you (or anybally else) can use your SoundPack by typing its direct link in the options of this userscript.
